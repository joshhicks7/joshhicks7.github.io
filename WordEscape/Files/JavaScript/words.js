...
*/
    ...
    {	
    	switch(list)
    	{
            ...
            case "geography":return geography; break;

            case "art":return art;break;

            case "monsters":return monsters;break;
